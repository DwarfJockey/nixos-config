...
**Key flake inputs:** nixpkgs (unstable), nixos-hardware, impermanence, disko, home-manager, noctalia, noctalia-greeter, nixvim, umbriel, xdg-desktop-portal-umbriel, zen-browser, firefox-addons, nixcord, agenix, stylix. Everything follows the one `nixpkgs`; nothing pins a second tree.
